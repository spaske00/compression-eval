...
#include "../../../../../../../upstream/src/shared/qtsingleapplication/qtlocalpeer.h"
...
namespace {
struct qt_meta_tag_ZN11SharedTools11QtLocalPeerE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11SharedTools11QtLocalPeerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN11SharedTools11QtLocalPeerE[] = {
...
Q_CONSTINIT const QMetaObject SharedTools::QtLocalPeer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11SharedTools11QtLocalPeerE.offsetsAndSizes,
    qt_meta_data_ZN11SharedTools11QtLocalPeerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11SharedTools11QtLocalPeerE_t,
        // Q_OBJECT / Q_GADGET
...
void SharedTools::QtLocalPeer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QtLocalPeer::*)(const QString & , QObject * );
            if (_q_method_type _q_method = &QtLocalPeer::messageReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *SharedTools::QtLocalPeer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11SharedTools11QtLocalPeerE.stringdata0))
