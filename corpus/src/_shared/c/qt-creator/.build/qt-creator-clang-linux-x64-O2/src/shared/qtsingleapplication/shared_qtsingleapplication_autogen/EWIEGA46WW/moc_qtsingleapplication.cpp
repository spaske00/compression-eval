...
#include "../../../../../../../upstream/src/shared/qtsingleapplication/qtsingleapplication.h"
...
namespace {
struct qt_meta_tag_ZN11SharedTools19QtSingleApplicationE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN11SharedTools19QtSingleApplicationE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN11SharedTools19QtSingleApplicationE[] = {
...
Q_CONSTINIT const QMetaObject SharedTools::QtSingleApplication::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11SharedTools19QtSingleApplicationE.offsetsAndSizes,
    qt_meta_data_ZN11SharedTools19QtSingleApplicationE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11SharedTools19QtSingleApplicationE_t,
        // Q_OBJECT / Q_GADGET
...
void SharedTools::QtSingleApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (QtSingleApplication::*)(const QString & , QObject * );
            if (_q_method_type _q_method = &QtSingleApplication::messageReceived; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (QtSingleApplication::*)(const QString & );
            if (_q_method_type _q_method = &QtSingleApplication::fileOpenRequest; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *SharedTools::QtSingleApplication::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11SharedTools19QtSingleApplicationE.stringdata0))
