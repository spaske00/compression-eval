static void metadata_gpu_shader_material_volume_coefficients_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_volume_coefficients", args, g_functions);
  }
  source.add_dependency("gpu_shader_material_blackbody.glsl");
