static void metadata_gpu_shader_compositor_set_value_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("set_float", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
      metadata::ArgumentFormat{metadata::Qualifier(3766795653032124588LLU), metadata::Type(5601490213402017593LLU)},
      metadata::ArgumentFormat{metadata::Qualifier(18095486126876356427LLU), metadata::Type(5601490213402017593LLU)},
    };
    source.add_function("set_float2", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
    ...
    source.add_function("set_float3", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
    ...
    source.add_function("set_float4", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
      metadata::ArgumentFormat{metadata::Qualifier(3766795653032124588LLU), metadata::Type(5601490213402017599LLU)},
    ...
    source.add_function("set_quaternion", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
      metadata::ArgumentFormat{metadata::Qualifier(3766795653032124588LLU), metadata::Type(5601490213402017599LLU)},
    ...
    source.add_function("set_color", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
    ...
    source.add_function("set_float4x4", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
      metadata::ArgumentFormat{metadata::Qualifier(18095486126876356427LLU), metadata::Type(2120460826536408571LLU)},
    };
    source.add_function("set_float4x4_default", args, g_functions);
  }
