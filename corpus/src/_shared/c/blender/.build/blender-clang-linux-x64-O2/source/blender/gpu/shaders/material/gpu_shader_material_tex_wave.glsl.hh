static void metadata_gpu_shader_material_tex_wave_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_tex_wave", args, g_functions);
  }
  source.add_dependency("gpu_shader_common_hash.glsl");
  source.add_dependency("gpu_shader_material_fractal_noise.glsl");
  source.add_dependency("gpu_shader_material_noise.glsl");
