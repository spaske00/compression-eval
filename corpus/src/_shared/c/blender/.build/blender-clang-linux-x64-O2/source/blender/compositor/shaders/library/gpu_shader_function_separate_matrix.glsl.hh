static void metadata_gpu_shader_function_separate_matrix_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_function_separate_matrix", args, g_functions);
  }
