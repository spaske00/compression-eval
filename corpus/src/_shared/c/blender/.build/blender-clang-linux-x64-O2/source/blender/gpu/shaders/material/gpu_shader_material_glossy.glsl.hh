static void metadata_gpu_shader_material_glossy_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_bsdf_glossy", args, g_functions);
  }
