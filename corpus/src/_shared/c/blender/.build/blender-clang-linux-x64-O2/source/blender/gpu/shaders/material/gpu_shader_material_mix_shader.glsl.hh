static void metadata_gpu_shader_material_mix_shader_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_mix_shader", args, g_functions);
  }
