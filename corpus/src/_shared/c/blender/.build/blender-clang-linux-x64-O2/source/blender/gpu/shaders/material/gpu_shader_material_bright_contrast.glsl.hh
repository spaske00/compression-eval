static void metadata_gpu_shader_material_bright_contrast_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("brightness_contrast", args, g_functions);
  }
