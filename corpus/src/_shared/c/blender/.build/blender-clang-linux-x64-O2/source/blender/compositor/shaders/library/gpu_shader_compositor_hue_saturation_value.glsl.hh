static void metadata_gpu_shader_compositor_hue_saturation_value_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_hue_saturation_value", args, g_functions);
  }
