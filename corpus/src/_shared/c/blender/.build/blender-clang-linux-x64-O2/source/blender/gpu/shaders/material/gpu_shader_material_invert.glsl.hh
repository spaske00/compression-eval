static void metadata_gpu_shader_material_invert_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("invert", args, g_functions);
  }
