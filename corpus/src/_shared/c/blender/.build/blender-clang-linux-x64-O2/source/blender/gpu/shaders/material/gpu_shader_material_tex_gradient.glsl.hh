static void metadata_gpu_shader_material_tex_gradient_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_tex_gradient", args, g_functions);
  }
