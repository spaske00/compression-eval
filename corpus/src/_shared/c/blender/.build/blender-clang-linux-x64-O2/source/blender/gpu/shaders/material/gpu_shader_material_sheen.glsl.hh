static void metadata_gpu_shader_material_sheen_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_bsdf_sheen", args, g_functions);
  }
