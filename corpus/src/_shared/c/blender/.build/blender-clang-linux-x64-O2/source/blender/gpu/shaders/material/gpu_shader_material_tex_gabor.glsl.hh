static void metadata_gpu_shader_material_tex_gabor_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_tex_gabor", args, g_functions);
  }
