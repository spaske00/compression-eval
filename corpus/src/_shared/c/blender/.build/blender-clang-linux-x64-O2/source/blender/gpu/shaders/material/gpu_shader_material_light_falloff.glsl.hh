static void metadata_gpu_shader_material_light_falloff_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_light_falloff", args, g_functions);
  }
