static void metadata_gpu_shader_material_squeeze_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("squeeze", args, g_functions);
  }
