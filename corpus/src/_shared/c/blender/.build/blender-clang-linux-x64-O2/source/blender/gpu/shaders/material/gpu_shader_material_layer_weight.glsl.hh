static void metadata_gpu_shader_material_layer_weight_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_layer_weight", args, g_functions);
  }
  source.add_dependency("gpu_shader_material_fresnel.glsl");
