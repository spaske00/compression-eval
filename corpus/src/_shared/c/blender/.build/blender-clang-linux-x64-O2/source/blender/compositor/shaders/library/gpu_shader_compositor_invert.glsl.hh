static void metadata_gpu_shader_compositor_invert_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_invert", args, g_functions);
  }
