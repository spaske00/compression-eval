static void metadata_eevee_geom_pointcloud_bsl_hh_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  ...
  source.add_dependency("eevee_attributes_pointcloud_lib.glsl");
