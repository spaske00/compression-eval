static void metadata_gpu_shader_compositor_exposure_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_exposure", args, g_functions);
  }
