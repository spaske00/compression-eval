static void metadata_gpu_shader_material_uv_map_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_uvmap", args, g_functions);
  }
