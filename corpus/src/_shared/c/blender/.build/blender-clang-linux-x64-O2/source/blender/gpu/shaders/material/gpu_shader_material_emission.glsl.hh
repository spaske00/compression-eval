static void metadata_gpu_shader_material_emission_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_emission", args, g_functions);
  }
