static void metadata_gpu_shader_function_invert_matrix_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_function_invert_matrix", args, g_functions);
  }
