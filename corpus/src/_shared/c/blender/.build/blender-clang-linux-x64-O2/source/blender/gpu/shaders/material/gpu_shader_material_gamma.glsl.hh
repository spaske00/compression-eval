static void metadata_gpu_shader_material_gamma_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_gamma", args, g_functions);
  }
