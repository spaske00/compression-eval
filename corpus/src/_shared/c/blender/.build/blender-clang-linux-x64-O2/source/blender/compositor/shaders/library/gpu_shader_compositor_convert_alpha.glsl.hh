static void metadata_gpu_shader_compositor_convert_alpha_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_convert_alpha", args, g_functions);
  }
