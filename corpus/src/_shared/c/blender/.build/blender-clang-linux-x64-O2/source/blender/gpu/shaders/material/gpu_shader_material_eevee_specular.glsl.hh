static void metadata_gpu_shader_material_eevee_specular_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_eevee_specular", args, g_functions);
  }
