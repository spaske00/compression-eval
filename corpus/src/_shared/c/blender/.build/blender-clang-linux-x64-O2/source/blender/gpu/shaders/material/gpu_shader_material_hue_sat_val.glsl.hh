static void metadata_gpu_shader_material_hue_sat_val_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("hue_sat", args, g_functions);
  }
