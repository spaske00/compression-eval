static void metadata_gpu_shader_material_combine_xyz_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("combine_xyz", args, g_functions);
  }
