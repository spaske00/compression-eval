static void metadata_gpu_shader_material_normal_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("normal_new_shading", args, g_functions);
  }
