static void metadata_overlay_edit_mesh_edge_vert_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  ...
  source.add_dependency("overlay_edit_mesh_lib.glsl");
