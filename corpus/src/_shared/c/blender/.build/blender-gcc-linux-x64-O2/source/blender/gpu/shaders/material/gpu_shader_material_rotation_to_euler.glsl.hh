static void metadata_gpu_shader_material_rotation_to_euler_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("rotation_to_euler", args, g_functions);
  }
