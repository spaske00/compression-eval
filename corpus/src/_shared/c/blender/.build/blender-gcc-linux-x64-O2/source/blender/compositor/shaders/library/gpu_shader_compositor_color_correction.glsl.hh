static void metadata_gpu_shader_compositor_color_correction_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_color_correction", args, g_functions);
  }
