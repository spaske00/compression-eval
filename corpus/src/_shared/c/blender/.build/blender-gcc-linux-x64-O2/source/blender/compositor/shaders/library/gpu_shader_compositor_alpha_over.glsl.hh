static void metadata_gpu_shader_compositor_alpha_over_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_alpha_over", args, g_functions);
  }
