static void metadata_gpu_shader_material_fresnel_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_fresnel", args, g_functions);
  }
