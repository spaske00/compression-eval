static void metadata_gpu_shader_material_vertex_color_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_vertex_color", args, g_functions);
  }
