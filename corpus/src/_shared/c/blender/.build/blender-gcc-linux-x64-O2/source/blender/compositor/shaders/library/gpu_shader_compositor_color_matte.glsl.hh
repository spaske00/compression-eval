static void metadata_gpu_shader_compositor_color_matte_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_composite_color_matte", args, g_functions);
  }
