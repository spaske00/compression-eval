static void metadata_gpu_shader_function_transform_direction_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_function_transform_direction", args, g_functions);
  }
