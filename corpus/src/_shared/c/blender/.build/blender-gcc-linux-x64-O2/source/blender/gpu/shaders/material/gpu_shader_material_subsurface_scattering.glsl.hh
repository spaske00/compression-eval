static void metadata_gpu_shader_material_subsurface_scattering_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_subsurface_scattering", args, g_functions);
  }
