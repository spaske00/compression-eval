static void metadata_gpu_shader_function_matrix_determinant_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_function_matrix_determinant", args, g_functions);
  }
