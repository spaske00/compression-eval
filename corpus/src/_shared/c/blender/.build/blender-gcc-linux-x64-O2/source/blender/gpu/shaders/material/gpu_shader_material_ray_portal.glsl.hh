static void metadata_gpu_shader_material_ray_portal_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_bsdf_ray_portal", args, g_functions);
  }
