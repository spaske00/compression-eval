static void metadata_gpu_shader_material_texture_coordinates_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_tex_coord_position", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
    ...
    source.add_function("node_tex_coord", args, g_functions);
  }
