static void metadata_gpu_shader_material_ambient_occlusion_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_ambient_occlusion", args, g_functions);
  }
