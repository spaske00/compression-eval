static void metadata_gpu_shader_material_bump_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("differentiate_texco", args, g_functions);
  }
  {
    Vector<metadata::ArgumentFormat> args = {
  ...
  }
  {
    ...
    source.add_function("node_bump", args, g_functions);
  }
