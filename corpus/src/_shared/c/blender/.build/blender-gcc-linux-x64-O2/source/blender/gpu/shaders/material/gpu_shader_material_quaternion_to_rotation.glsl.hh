static void metadata_gpu_shader_material_quaternion_to_rotation_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("quaternion_to_rotation", args, g_functions);
  }
