static void metadata_gpu_shader_material_particle_info_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("particle_info", args, g_functions);
  }
