static void metadata_compositor_summed_area_table_compute_incomplete_prologues_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
