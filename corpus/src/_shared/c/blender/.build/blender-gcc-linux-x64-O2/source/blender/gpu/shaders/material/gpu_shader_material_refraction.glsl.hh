static void metadata_gpu_shader_material_refraction_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_bsdf_refraction", args, g_functions);
  }
