static void metadata_workbench_effect_dof_downsample_frag_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  ...
  source.add_dependency("workbench_effect_dof_lib.glsl");
