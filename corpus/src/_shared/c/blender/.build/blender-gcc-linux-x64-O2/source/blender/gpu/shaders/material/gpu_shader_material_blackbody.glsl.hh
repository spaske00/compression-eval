static void metadata_gpu_shader_material_blackbody_glsl_tmp(GPUSource &source, GPUFunctionDictionary *g_functions, GPUPrintFormatMap *g_formats) {
  {
    ...
    source.add_function("node_blackbody", args, g_functions);
  }
